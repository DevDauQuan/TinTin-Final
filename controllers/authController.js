...
const authController = {
    register: async (req, res) => {
        try {
            ...
            const newUser2 = {
                fullname, email, password: passwordHash, username: newUserName, gender
            }

            const activation_token = createActivationToken(newUser2);
    ...
    googleLogin: async (req, res) => {
        try {
            ...
            if (user) {
                ...
                const newUser = new Users({
                    username: email, fullname: name, email, password: passwordHash, avatar: picture
                })
